...
We will calculate the metrics of the second confusion matrix that we obtained (that whan that had the cut-off point of 0.25).

```{r}
# First, we will save as variables each type of correct and incorrect prediction
